...
import { auth, db, createUserDoc } from "../../lib/firebase";
import {
...
export default function Signup() {
  ...
  async function handleSignup(e) {
    ...
    try {
      ...
      // After signup, normal users go to homepage (D). Sellers (if manually set later) will be redirected on next auth change.
      router.replace("/");
    } catch (err) {
      ...
      <div className="w-full max-w-5xl">
        <div className="flex justify-between mb-6 items-center">
          ...
          <div className="flex items-center space-x-3">
            ...
            <Link href="/auth/signin" className="px-3 py-1 rounded-md border text-sm">
              Sign in
            </Link>
          </div>
        </div>
        ...
        >
          <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg p-8">
            ...
            <p className="text-sm text-gray-500 dark:text-gray-300 mb-6">
              Join BookSwaply to buy and sell second-hand books in your city.
            </p>
            ...
            <div className="mt-5 text-center text-sm text-gray-500 dark:text-gray-300">Or sign up with</div>
            ...
            <div className="mt-4 text-sm text-center">
              ...
              <Link href="/auth/signin" className="text-emerald-600 dark:text-emerald-400 font-medium">
                Sign in
              </Link>
            </div>
          </div>
          ...
          <div className="flex justify-center">
            ...
            >
              <div>
                <h3 className="text-lg font-semibold">Start swapping books</h3>
                <p className="text-sm text-gray-600 dark:text-gray-300 mt-2">
                  Create your account and list your pre-loved books to reach local buyers.
                </p>
              </div>
